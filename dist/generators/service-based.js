...
exports.generateServiceBasedStructure = void 0;
const fs_extra_1 = __importDefault(require("fs-extra"));
const path_1 = __importDefault(require("path"));
async function generateServiceBasedStructure(projectPath) {
...
exports.generateServiceBasedStructure = generateServiceBasedStructure;
function generateServiceHealthController() {
...
function generateServiceUserController() {
    return `import { Request, Response } from 'express';
...
function generateServiceHealthService() {
...
function generateServiceUserService() {
...
function generateServiceUserModel() {
...
function generateServiceHealthRoute() {
...
function generateServiceUserRoute() {
    return `import { Router } from 'express';
...
function generateServiceRoutesIndex() {
    return `import { Router } from 'express';
...
function generateServiceUserTypes() {
...
function generateServiceUserValidation() {
