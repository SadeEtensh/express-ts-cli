...
function generateHealthTypes(): string {
...
function generateHealthValidation(): string {
...
function generateHealthRouteIndex(): string {
  return `import { Router } from 'express';
...
function generateUserValidation(): string {
  return `import Joi from 'joi';
...
function generateUserRouteIndex(): string {
  return `import { Router } from 'express';
...
function generateFeatureController(featureName: string): string {
...
function generateFeatureService(featureName: string): string {
  const className = featureName.charAt(0).toUpperCase() + featureName.slice(1);
...
function generateFeatureTypes(featureName: string): string {
  const className = featureName.charAt(0).toUpperCase() + featureName.slice(1);
...
function generateFeatureValidation(featureName: string): string {
  const className = featureName.charAt(0).toUpperCase() + featureName.slice(1);
  return `import Joi from 'joi';
...
function generateFeatureModel(featureName: string): string {
  const className = featureName.charAt(0).toUpperCase() + featureName.slice(1);
  return `import { Schema, model, Document } from 'mongoose';
